...
export default class extends Component{
 constructor() {
   ...
   courses_advanced:[
    ,{ key:35, title: "LayoutAnimation", component: Course36, isFA: false, icon: "ios-beer", size: 50, color: "#55ab6b", hideNav: false, }
   ...
   courses_actual_combat:[
     ,{ key:40, title: "电影数据的App", component: Course41, isFA: false, icon: "ios-tennisball", size: 50, color: "#893D54", hideNav: false, }
     ,{ key:41, title: "微信好友/朋友圈分享", component: Course42, isFA: false, icon: "ios-tennisball-outline", size: 50, color: "#893D54", hideNav: false, }
   ]
   }
 }
